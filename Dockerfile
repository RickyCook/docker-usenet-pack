...
RUN git clone https://github.com/RickyCook/docker-usenet-pack.git /opt/docker-usenet-pack/ && cd /opt/docker-usenet-pack/ && git checkout 4e71319e0aac590317ec335a852a80b6adc70e40
